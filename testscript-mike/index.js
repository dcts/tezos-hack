...
var conseilServer = {
    ...
    apiKey: 'a37a637c-4ad8-477c-b7e5-c74b3c5b728f',
    network: 'babylonnet'
};
...
function deployMichelineContract() {
    return __awaiter(this, void 0, void 0, function () {
        var contract, storage, nodeResult, groupid, conseilResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, conseiljs_1.TezosNodeWriter.sendContractOriginationOperation(tezosNode, keystore, 0, undefined, 100000, '', 1000, 100000, contract, storage, conseiljs_1.TezosParameterFormat.Micheline)];
                case 1:
                    nodeResult = _a.sent();
                    groupid = clearRPCOperationGroupHash(nodeResult['operationGroupID']);
                    console.log("Injected origination operation with " + groupid);
